    ...
    categories: [
      {
        ...
        spent: 0,
        expenses: [
          { id: "exp-001", concept: "Vuelo Madrid ↔ Katmandú (Qatar)", amount: 270.0, isEstimate: true, date: today },
          { id: "exp-002", concept: "Vuelo Katmandú → Paro (Drukair)", amount: 227.76, isEstimate: true, date: today },
          { id: "exp-003", concept: "Vuelo Paro → Katmandú (Bhutan Airlines)", amount: 196.21, isEstimate:true, date: today },
          { id: "exp-004", concept: "Taxis Aeropuerto (4 viajes)", amount: 28.0, isEstimate: true, date: today },
          { id: "exp-005", concept: "Taxis Ciudad (4 viajes)", amount: 12.0, isEstimate: true, date: today },
          { id: "exp-006", concept: "Autobuses (2 viajes)", amount: 1.0, isEstimate: true, date: today }
        ]
      },
      {
        id: "tour",
        ...
        spent: 0,
        expenses: [
          { id: "exp-007", concept: "Itinerario \"Best of Bhutan\"", amount: 1602.0, isEstimate: true, date: today },
        ]
      },
      {
        id: "comida",
        ...
        spent: 0,
        expenses: [
          { id: "exp-008", concept: "Comidas en Nepal", amount: 187.0, isEstimate: true, date: today },
          { id: "exp-009", concept: "Bebidas", amount: 45.0, isEstimate: true, date: today }
        ]
      },
      {
        id: "entradas-visados",
        ...
        spent: 0,
        expenses: [
          { id: "exp-010", concept: "Visado de Nepal (30 días)", amount: 50.0, isEstimate: true, date: today },
          { id: "exp-011", concept: "Plaza Durbar, Katmandú", amount: 7.0, isEstimate: true, date: today },
          { id: "exp-012", concept: "Swayambhunath (Templo de los Monos)", amount: 1.5, isEstimate: true, date: today },
          { id: "exp-013", concept: "Pashupatinath", amount: 7.0, isEstimate: true, date: today },
          { id: "exp-014", concept: "Estupa de Boudhanath", amount: 3.0, isEstimate: true, date: today },
          { id: "exp-015", concept: "Monasterio Taktsang (Nido del Tigre)", amount: 22.0, isEstimate: true, date: today },
          { id: "exp-016", concept: "Tashichho Dzong", amount: 11.0, isEstimate: true, date: today },
          { id: "exp-017", concept: "Punakha Dzong", amount: 11.0, isEstimate: true, date: today },
          { id: "exp-018", concept: "Memorial Chorten", amount: 11.0, isEstimate: true , date: today },
          { id: "exp-019", concept: "Buddha Dordenma", amount: 11.0, isEstimate: true, date: today },
          { id: "exp-020", concept: "Rinpung Dzong", amount: 11.0, isEstimate: true, date: today }
        ]
      },
      {
        id: "alojamiento",
        ...
        spent: 0,
        expenses: [
            { id: "exp-021", concept: "Hotel New Era (10-12 Oct)", amount: 33.0, isEstimate: true, date: today },
            { id: "exp-022", concept: "Hotel New Era (19-20 Oct)", amount: 16.5, isEstimate: true, date: today },
            { id: "exp-023", concept: "Hotel New Era (25-26 Oct)", amount: 16.5, isEstimate: true, date: today }
        ]
      },
      {
        id: "actividades-ocio",
        ...
        spent: 0,
        expenses: [
          { id: "exp-024", concept: "Parapente en Pokhara (Opcional)", amount: 80.0, isEstimate: true , date: today },
        ]
      },
      {
        ...
        spent: 0,
        expenses: [
          { id: "exp-025", concept: "Souvenirs", amount: 45.0, isEstimate: true, date: today },
          { id: "exp-026", concept: "Lavandería", amount: 5.0, isEstimate: true, date: today },
        ]
      },
      {
        ...
        spent: 0,
        expenses: [
          { id: "exp-027", concept: "Propinas", amount: 55.0, isEstimate: true, date: today },
          { id: "exp-028", concept: "Fondo Común Estimado", amount: 50.0, isEstimate: true, date: today },
          { id: "exp-029", concept: "Comunicaciones (SIM)", amount: 8.0, isEstimate: true, date: today },
          { id: "exp-030", concept: "Propinas Guía y Conductor", amount: 90.0, isEstimate: true, date: today }
        ]
      },
      {
        id: "contingencia",
        ...
        spent: 0,
        expenses: [
          { id: "exp-031", concept: "Fondo para Imprevistos (Nepal)", amount: 149.2, isEstimate: true , date: today },
          { id: "exp-032", concept: "Fondo para Imprevistos (Bután)", amount: 176.35, isEstimate: true, date: today }
        ]
      }
    ]
  },
