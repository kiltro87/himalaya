    ...
    "categories": [
      {
        ...
        "expenses": [
          {
            "id": "exp-transporte-01",
            "concept": "Vuelo Madrid ↔ Katmandú (Qatar)",
            "amount": 270.0,
            "date": "2025-10-01",
            "isEstimate": true
          },
          {
            "id": "exp-transporte-02",
            "concept": "Vuelo Katmandú → Paro (Drukair)",
            "amount": 227.76,
            "date": "2025-10-01",
            "isEstimate": true
          },
          {
            "id": "exp-transporte-03",
            "concept": "Vuelo Paro → Katmandú (Bhutan Airlines)",
            "amount": 196.21,
            "date": "2025-10-01",
            "isEstimate": true
          },
          {
            "id": "exp-transporte-04",
